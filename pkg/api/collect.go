...
func NewCollector(store datastore.Datastore) *Collector {
	bufferCap := 100                         // persist every 100 pageviews, see https://github.com/jelmer/grasp/issues/132
...
func (c *Collector) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	// indicate that we're not tracking user data, see https://github.com/jelmer/grasp/issues/65
	w.Header().Set("Tk", "N")
...
func shouldCollect(r *http.Request) bool {
	...
	// don't track prerendered pages, see https://github.com/jelmer/grasp/issues/13
